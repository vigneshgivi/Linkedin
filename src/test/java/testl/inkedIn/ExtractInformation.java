...
public class ExtractInformation extends Appbase {
    ...
    public void selectFilter() throws AWTException, InterruptedException {
        Thread.sleep(10000);
        driver.findElement(By.xpath("(//input[contains(@id,'jobs-search-box-keyword-id')])"))
        ...
        WebElement mouseHoverToexperienceFilter = driver.findElement(By.xpath("//button[@id='searchFilter_experience']"));
        ...
        WebElement mouseHoverToexperienceFilterShowResult = driver.findElement(By.xpath("(//button[contains(@aria-label,'Apply current filter to show')])[2]"));
